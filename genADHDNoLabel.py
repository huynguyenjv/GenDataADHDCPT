...
NUM_SUBJECTS = 1000        # Số người cần sinh dữ liệu
NUM_TRIALS = 1200         # Số trial mỗi người
TARGET_RATE = 0.3        # Xác suất xuất hiện Target (VD: 30%)

# Khoảng random CHO NHÓM ADHD (ép cao) - hoặc tùy bạn
OMISSION_RANGE = (0.15, 0.30)     # >= 15%
COMMISSION_RANGE = (0.10, 0.20)   # >= 10%
RT_MEAN_RANGE = (600, 800)        # >= 600ms
RT_STD_RANGE  = (100, 150)        # >= 100ms

# Thư mục đầu ra
OUTPUT_DIR = "adhd_data_no_label"
...
# ----------------------------------
# 4. CHẠY CHÍNH (BỎ PHẦN NHÃN)
# ----------------------------------
def main():
    for subject_id in range(1, NUM_SUBJECTS + 1):
        # a) Random “đặc điểm” trong vùng cao
        ...
        # c) Lưu file CSV (không có cột Label)
